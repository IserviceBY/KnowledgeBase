...
IEEE specifies in the IEEE 802.3 family of standards that the Ethernet protocol touches both Layer 1 (physical layer) and Layer 2 (data link layer) on the Open System Interconnection model (OSI).

Ethernet defines two units of transmission: packet and frame. The frame includes the payload of data being transmitted.
